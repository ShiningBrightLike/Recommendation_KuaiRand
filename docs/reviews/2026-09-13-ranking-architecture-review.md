...
- 泄漏审计：去掉 51 列全期统计特征后四任务平均测试 AUC −0.0317，门控均值 −0.0072（`docs/leakage_audit.md`）。
- 对照模型：Logistic 0.6851、Shared-Bottom 0.7200、单任务 0.7186、MMoE 0.7219（四任务平均，`docs/assets/baselines_v1.md`）。
